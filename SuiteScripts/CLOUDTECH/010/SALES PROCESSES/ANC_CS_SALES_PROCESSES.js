    ...
    (runtime, search, url, uimessage, currentRecord) => {
        ...
        const pageInit = (scriptContext) => {
            ...
            try {
                ...
                var custpage_anc_donotrefreshflag = currRecObj.getValue({
                    fieldId : "custpage_anc_donotrefreshflag",
                })
                console.log("custpage_anc_donotrefreshflag", custpage_anc_donotrefreshflag)
                if(custpage_anc_donotrefreshflag && custpage_anc_donotrefreshflag != "F")
                {
                ...
                var custpage_anc_refreshsourcewindow = currRecObj.getValue({
                    fieldId : "custpage_anc_refreshsourcewindow",
                })
                if(custpage_anc_refreshsourcewindow && custpage_anc_refreshsourcewindow != "F")
                {
                ...
                var custpage_anc_autoclose = currRecObj.getValue({
                    fieldId : "custpage_anc_autoclose",
                })
                if(custpage_anc_autoclose && custpage_anc_autoclose != "F")
                {
                    window.close();
                }
                else
