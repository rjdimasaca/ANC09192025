 ...
 */
define(['N/config', 'N/email', 'N/file', 'N/https', 'N/record', 'N/redirect', 'N/runtime', 'N/search', 'N/ui/message', 'N/ui/serverWidget', 'N/url', 'N/task', './customReordering_repair.config.js'],
/**
 * @param {config} config
 * @param {email} email
 * @param {file} file
...
//	      });
    ...
    function getDataForSublist(context)
    {
    	...
    	try
    	{
        	...
        	if(latestBatchId)
        	{
        	    //[SCRIPT] Batch Depleted Items to Reorder
...
//        		log.debug("repairableFilterObj", repairableFilterObj);
    ...
    function listingForm(context, dataForSublist)
    {
    	form = serverWidget.createForm({
    		title : "Reordering (Repairable Items)"
    	});
    	
    	/*var clientScriptInternalId = 217033;//TODO file id of 010CS_customReordering_repair.js
		form.clientScriptFileId = clientScriptInternalId;*/
    	
    	form.clientScriptModulePath = "./010CS_customReordering_repair.js";
